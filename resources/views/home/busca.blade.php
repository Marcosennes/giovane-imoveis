<section id="conteudo">
    <div class="container-fluid d-flex justify-content-center">
        <div class="row mt-5">
            <div class="col-sm-3">
                <div class="card">
                    <img src=" {{asset('images/casa_3.jpg')}} " class="card-img-top" width="100%">
                    <div class="card-body pt-0 px-0">
                        <div class="d-flex flex-row justify-content-between mb-0 pt-2 px-3">
                        ...
                        <div class="d-flex flex-row justify-content-between p-4 mid">
                            <div class="d-flex flex-column">
                                <div class="d-flex flex-row"><i class="fa-solid fa-bed"></i>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex flex-row"><i class="fa-solid fa-toilet"></i>
                                    <div class="d-flex flex-column ml-1">
										<p>2</p>
									</div>
                                </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex flex-row"><i class="fa-solid fa-car"></i>
                                    <div class="d-flex flex-column ml-1">
										<p>2</p>
									</div>
                                </div>
                        ...
                        <div class="mx-3 mt-3 mb-2"><button type="button" class="btn btn-danger btn-block"><small>BUILD
                                    &
                    ...
                    <div class="card-body pt-0 px-0">
                        ...
                        <div class="d-flex flex-row justify-content-between p-3 mid">
                            <div class="d-flex flex-column"><small class="text-muted mb-1">ENGINE</small>
                                <div class="d-flex flex-row"><i class="fa-solid fa-bed"></i>
                                    <div class="d-flex flex-column ml-1"><small class="ghj">1.4L
                                            MultiAir</small><small class="ghj">16V I-4 Turbo</small></div>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0 px-0">
                        ...
                        <div class="mx-3 mt-3 mb-2"><button type="button"
                                class="btn btn-danger btn-block"><small>BUILD
                                    &
                                    PRICE</small></button></div>
                        <small class="d-flex justify-content-center text-muted">*Legal Disclaimer</small>
                    </div>
